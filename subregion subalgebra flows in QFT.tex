...
% Title
\title{Subsystem flows, Ergodic theory and QFT}
...
The passage from a reversible microscopic description to an apparently irreversible macroscopic one is often attributed to information loss during coarse-graining. We start with a measure-theoretic definition of the algebra of observables, states, and dynamics of a classical system on some configuration space $X$ (space of microstates). In subsection \ref{}, we describe two types of coarse-grainings that we call subspace and subalgebra coarse-grainings. This work is primarily concerned with the latter case. Subsection \ref{} contains a review of classical ergodic theory.

In subsection \ref{}, we argue that if $X$ is endowed with a Poisson bracket, we say we have a Hamiltonian system that associates flows (dynamics) to (conserved) observables and (invariant) states, providing a classical avatar of modular flow. Finally, in subsection \ref{}, we discuss the subsystem flow in Hamiltonian systems.
...
\subsection{Subspace and subsystem classical coarse-grainings}
\label{subsec:classical-region-subsystem}
...
\subsection{Subsystem flows in Hamiltonian systems}
